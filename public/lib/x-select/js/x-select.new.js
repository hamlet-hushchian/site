(function ($) {
    $.fn.xSelect = function () {
        var wrap = this.find('.x-select-wrap');
        checker_container = {};
        tagContainer = $('.x-tag-container');

        //Set values on load
        $.each(wrap.find('.x-select-item-wrap.checker'), function () {
            var parent = $(this).data('parent');
            checker_container[parent] = [];
            $.each($(this).find('.x-select-tt-item.checked'), function () {
                checker_container[parent].push($(this).data('value'));
            });
        ...
        //To slide down
        wrap.find('.x-select').click(function () {
            wrap.find('.x-select').not(this).parent('div').removeClass('opened');
            $(this).parent('div').toggleClass('opened');
        });

        //Hover on item
        wrap.find('.x-select-tt-item').hover(function () {
            $(this).closest('.x-select-tt').find('.x-select-tt-item').removeClass('hovered');
            $(this).addClass('hovered');
        });

        //Choose item
        wrap.find('.x-select-tt-item').click(function () {
...
//Render list from array of items
